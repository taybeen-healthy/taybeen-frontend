...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <div className={cn("relative flex items-center bg-[#FDFCF9] hover:bg-white border border-[#C4A482]/30 hover:border-brand-primary/60 focus-within:border-brand-primary focus-within:ring-2 focus-within:ring-brand-primary/10 rounded-full py-2 pl-4 pr-10 transition-all duration-300 w-full max-w-[280px]", className)}>
