...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-bg border-t border-[#E5E5E5] pt-16 sm:pt-20 pb-10 md:pb-12">
      <div className="max-w-[1440px] mx-auto px-6 md:px-8 lg:px-10 xl:px-10 2xl:px-12">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-6 mb-16 max-w-2xl mx-auto">
          ...
          <div className="relative w-full max-w-xl">
            ...
            />
            <button className="absolute right-1.5 top-1.5 bg-brand-green-light text-white px-5 md:px-7 py-2 rounded-full font-poppins text-xs md:text-sm hover:bg-opacity-90 transition-all font-semibold">
              Subscribe
            </button>
          </div>
        </div>
