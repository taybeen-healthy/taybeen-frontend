/**
 * Gifting — Premium gifting showcase with a restructured 12-column grid layout.
 * Features a nested section header, a large landscape card, and two smaller landscape cards on the right.
 */
