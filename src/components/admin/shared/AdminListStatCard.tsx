...
export const AdminListStatCard: React.FC<AdminListStatCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "bg-white border border-[#C4A482]/20 rounded-2xl p-6 shadow-sm flex flex-col justify-between gap-3 text-left font-poppins",
        className
      )}
    >
      ...
      <span className="text-3xl font-bold font-poppins text-[#3A2418]">{value}</span>
      {subtext && (
