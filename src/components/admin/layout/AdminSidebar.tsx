    ...
    <>
      ...
      <aside
        className={cn(
          ...
          isMobileOpen
            ? "translate-x-0 w-64 pt-6 h-screen top-0 z-50"
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isExpanded ? "w-full gap-4 px-3.5" : "w-12 justify-center",
                    isActive
        ...
        >
          {isExpanded || isMobileOpen ? (
            <div className="animate-in fade-in slide-in-from-left-2 duration-300 delay-300">
              <p className="text-[9px] text-[#8D7F75] font-poppins font-bold uppercase tracking-wider">
                Logged in as
              </p>
              <p className="text-xs text-brand-brown font-bold font-poppins truncate">
                admin@taybeen.com
              </p>
            </div>
          ) : (
            <div
              className="w-9 h-9 rounded-full bg-brand-primary/10 text-brand-primary font-bold text-sm flex items-center justify-center select-none cursor-pointer animate-in fade-in duration-300"
              title="admin@taybeen.com"
            >
              A
            </div>
          )}
