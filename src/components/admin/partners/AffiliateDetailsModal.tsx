...
import { X, User, Mail, Phone, MapPin, Briefcase, Calendar, Copy, Check, Share2, Zap, Ticket, Trash2 } from "lucide-react";
...
export const AffiliateDetailsModal: React.FC<AffiliateDetailsModalProps> = ({
  ...
  const [discountValueInput, setDiscountValueInput] = useState(
    partner.discountOffered && partner.discountOffered !== "-"
      ? partner.discountOffered
      : ""
  );
  ...
  const handleGenerateCoupon = () => {
    ...
    const formattedDiscount = discountValueInput.includes("%") || discountValueInput.toLowerCase().includes("off") || discountValueInput.includes("₹")
      ? discountValueInput
  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:p-8 pb-4 shrink-0 select-text pr-16">
        ...
        <p className="text-xs text-[#8D7F75] font-semibold mt-1">
          {getSubtitle()}
        </p>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="divide-y divide-[#C4A482]/10 border-t border-b border-[#C4A482]/10">
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <span className="font-bold text-brand-brown text-right break-all">{partner.email}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <span className="font-bold text-brand-brown text-right">{partner.phone || "+91 98001 23456"}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <span className="font-bold text-brand-brown text-right">{partner.city || "Pune, Maharashtra"}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <span className="font-bold text-brand-brown text-right">{partner.occupation || "Nutritionist"}</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-white border border-[#C4A482]/20 rounded-2xl p-4 shadow-sm text-center flex flex-col justify-center min-h-[90px]">
                <span className="text-base sm:text-lg font-bold text-brand-brown">
                  {partner.salesAmount === -1 ? "-" : `₹${formatIndianCurrency(partner.salesAmount)}`}
                </span>
            ...
            <div className="space-y-4">
              <div className="border border-dashed border-[#C4A482] rounded-2xl p-5 bg-[#FDFAF3] flex flex-col gap-3 relative overflow-hidden">
                <div className="flex items-center justify-between">
                  ...
                  <Badge text="Active" variant="success" className="px-2.5 py-0.5 text-[10px] font-bold" />
                </div>
                ...
                <div className="flex gap-2 items-center mt-1 w-full">
                  ...
                  />
                  <button
                    onClick={() => handleCopyLink(partner.refLink || `taybeen.in/ref?code=${partner.couponCode}`)}
                  ...
                  >
                    {copiedLink ? <Check size={14} className="text-brand-green" /> : <Copy size={14} />}
            ...
            <div className="space-y-4">
              <div className="border border-dashed border-[#C4A482]/50 rounded-2xl p-5 bg-[#FDFAF3] flex flex-col gap-3 opacity-80">
                <div className="flex items-center justify-between">
                  ...
                  <Badge text="Expired" variant="error" className="px-2.5 py-0.5 text-[10px] font-bold" />
                </div>
                <p className="text-xs text-[#8D7F75] font-semibold">
                  {partner.couponDetails || `20% off · Expired on ${partner.couponExpiryDate || "31 May 2025"}`}
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="border border-dashed border-[#C4A482]/40 rounded-2xl p-6 bg-[#FDFAF3] flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-xs text-[#8D7F75] font-semibold max-w-xs leading-relaxed">
                      No coupon yet. Fill in the details below and generate a code for this affiliate.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="space-y-1.5 text-left">
                      ...
                      <input
                        ...
                        value={discountValueInput}
                        onChange={(e) => setDiscountValueInput(e.target.value)}
                        placeholder={discountType === "Percentage" ? "Enter value e.g. 10%" : "Enter value e.g. ₹150 flat"}
          ...
          {currentStatus === "Pending" && isGeneratingCoupon && (
            <div className="space-y-4">
              <div className="border border-dashed border-[#C4A482]/40 rounded-2xl p-6 bg-[#FDFAF3] flex flex-col items-center justify-center text-center">
                <Ticket className="text-[#C4A482]/60 w-8 h-8 mb-2" />
                <p className="text-xs text-[#8D7F75] font-semibold max-w-xs leading-relaxed">
                  No coupon yet. Fill in the details below and generate a code to approve this affiliate.
                </p>
              </div>
