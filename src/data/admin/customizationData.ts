...
export const initialCustomizationData: AdminCustomizationConfig = {
  ...
  story: {
    ...
    description:
      "Every single date we offer is selected by hand, cleaned under strict hygienic guidelines, and transported in specialized cold storage to lock in its natural moist texture, rich vitamins, and authentic taste profile.",
    sectionImage: "/our-story-section.png",
    brandValues: [
      {
        title: "100% Authentic Sourcing",
        description:
          "Direct ties with certified organic farms across Al-Madinah, Al-Qassim, and Jordan Valley.",
      },
      {
        title: "Cold-Chain Logistics",
        description:
          "Maintained at steady optimal temperatures from harvest until it reaches your doorstep.",
      },
      {
        title: "Handpicked Quality",
        description:
          "Rigorous sorting process guarantees uniform size, moisture content, and zero defects.",
      },
    ],
  },
  offer: {
    ...
    description:
      "Experience premium date varieties today. Subscribe to our newsletter or create an account to receive an instant coupon for storewide discounts.",
  },
  delivery: {
